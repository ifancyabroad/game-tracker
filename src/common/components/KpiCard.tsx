export const KpiCard: React.FC<{ icon: React.ReactNode; label: string; value: React.ReactNode }> = ({
	...
	return (
		<div className="flex items-center gap-2.5 rounded-lg border border-[var(--color-border)] bg-[var(--color-accent)] px-2.5 py-2 shadow-sm transition-transform hover:-translate-y-0.5 sm:gap-3 sm:px-3">
