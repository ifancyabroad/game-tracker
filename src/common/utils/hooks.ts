...
/**
 * Hook to get events and results from contexts
 * Note: Previously filtered by year, now returns unfiltered data.
 * Individual features (like leaderboards) apply their own filters.
 */
